...
<head>
  <meta charset="UTF-8">
  <title>Software Development Course | Netzwerk Academy</title>
	...
	<div class="containe">
			<div class="row">
              ...
              <li class=""> <a href="software-testing.php">Software Testing</a></li>
							<li class="current"> <a href="software-development.php">Software Development</a></li>
					</ul>
					</nav> </div>
			</div>
	</div>
...
<div style="margin-top:10px;box-shadow: -5px 0px 10px 0px rgb(0 0 0 / 50%);">
			<div class="row">
				<div class="col-md-6">
					<img src="https://netzwerkacademy.com/wp-content/uploads/2021/02/Software-development-min.jpg" width="100%">
				</div>
				<div class="col-md-6">
					<h1 style="color:black">Software Development Course</h1>
		...
		<div class="row">
				<div class="col-md-12">
					...
					<p>Designed by Netzwerk Academy, THE FULL SUITE SOFTWARE DEVELOPMENT COURSE is the go to option for anyone with keen interest in this field, it covers wide array of topics from to Basics to OOP concepts, Packages, exception handling and advance concepts of J2EE like JSP, EJB and much more</p>
					...
					<p>The demand of Java developer is increasing every day in every field, the goal is to transform the code into working software module, and software module to business, which is possible with Java development course</p>
				</div>

				<div class="col-md-12">
					<h1 style="color:#033435">Scope of learning Software Development:</h1>
...
<div class="container">
	<div class="row">
		<center>
			<p style="font-size: 24px">Get the Software Development Course now at only Rs. 1499</p>
	...
	<input type="text" id="amount" name="amount" placeholder="Amount" value="1499" hidden="" />
    <input type="text" id="pinfo" name="pinfo" placeholder="Product Info" value="Software Development Course" hidden="" />
	...
	<div class="row">
		...
		<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
		    ...
		    <div class="panel-heading" role="tab" id="headingOne">
		      <h4 class="panel-title">
		        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
		          <ul><li style="margin-left:10px;font-size:17px">Advance Java </li></ul>
		        </a>
		      </h4>
		    </div>
		    <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
		      <div class="panel-body" style="color:black">
		        <ol type="1">
		        	<li style="font-size:16px">Introduction to Enterprise Edition</li>
							<li style="font-size:16px">HTML & XML</li>
							<li style="font-size:16px">Java Servlet Technology</li>
							<li style="font-size:16px">JSP Technology</li>
							<li style="font-size:16px">EJB (Enterprise Java Beans)</li>
							<li style="font-size:16px">Java Server Faces (JSF)</li>
							<li style="font-size:16px">Java Persistence API</li>
							<li style="font-size:16px">Java Mail API</li>
