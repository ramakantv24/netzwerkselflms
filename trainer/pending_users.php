            ...
            <div class="widget-shadow " data-example-id="basic-forms"> 
                ...
                <div class="form-body">
					...
					<div class="row">
					   ...
					   <div class="col-md-6">
					        <form method="GET" action="https://netzwerkself.com/lms/trainer/pending_users.php">
							    <div class="row">
                        ...
                        <tbody>
                            <?php
							    if(!empty($_GET['search'])) {
									$sql = "SELECT * FROM `users` where email='".$_GET['search']."' AND user_status = 'P' ORDER BY `users`.`ID` DESC";
								}else{									
                                   $sql = "SELECT * FROM `users` where user_status = 'P' ORDER BY `users`.`ID` DESC";
								}
