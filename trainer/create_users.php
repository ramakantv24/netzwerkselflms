<?php
    ...
    if(isset($_POST['email'])){
        ...
        $sqlMode = "INSERT INTO users SET uname='".$user_name."',email='".$email."',password='".$password."',mobile='".$mobile_no."',status='1',ip='".$my_ip."',timestamp='".$timestamp."',hash='".$hash."',payuID='".$payuID."',internatID='".$internatID."',user_id='".$user_id."'";
