...
if(isset($_POST['email'])){
	...
	if($result = mysqli_query($con, $sql)){
		...
		while ($row = mysqli_fetch_row($result)) {
			...
			$sql = "UPDATE `admin` SET `hash` = '$hash' WHERE `ID` LIKE '$ID'";
			if(mysqli_query($con, $sql)){
				$_SESSION['token'] = $hash;
				$_SESSION['id'] = $ID;
				$_SESSION['logged_in'] = 1;
				$_SESSION['uname'] = $row[5];
...
if(isset($_GET['ex'])){ 
	if($_GET['ex']=='in')
		$msg = '<span style="color:red;">Invalid Credentials. Try again</span>';
}
?>
<!DOCTYPE HTML>
<html lang="en">
		...
		<div class="row main-content bg-success text-center">
			<div class="col-md-6 col-sm-6 col-xs-12 text-center company__info">
				<span class="company__logo"><h2>
				    <!-- <img src="https://netzwerkself.com/lms_logo.png" style="height:300px;"/> -->
