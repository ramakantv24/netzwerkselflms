				...
				<div class="col-md-4 compose-left">
					<div class="folder widget-shadow">
						<ul>
							...
							<li><a href="#"><i class="fa fa-inbox"></i>Admin</a></li>
						</ul>
					</div>
				</div>
						...
						<div class="panel-body">
							<div class="panel panel-primary" style="border:0px">
				                ...
				                <div class="panel-body msg_container_base">
				                    <?php
				                    	$sql = "SELECT `message`,`timestamp`,`admin` FROM `chat` WHERE `uid` LIKE '$uid'";
				                        ...
				                        <div class="col-md-10 col-xs-10">
				                            <div class="messages msg_receive">
				                                <p>Hello '.$_SESSION['uname'].', How can we help you today ?</p>
				                            </div>
				                        </div>
				                    </div>';
				                    		}
				                    		while ($row = mysqli_fetch_row($result)) {
				                    			$admin = $row[2];
				                    			if($admin==0){
						                    			echo '<div class="row msg_container base_sent" style="margin-top:-30px">
						                        <div class="col-md-10 col-xs-10">
						                            <div class="messages msg_receive">
						                                <p>'.$row[0].'</p>
						                            </div>
								                	...
								                	echo '<div class="row msg_container base_receive" style="margin-top:-30px">
						                        <div class="col-md-10 col-xs-10">
						                            <div class="messages msg_receive">
						                                <p>'.$row[0].'</p>
						                            </div>
