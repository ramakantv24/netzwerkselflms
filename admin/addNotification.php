...
if(isset($_POST['selector1'])){
  ...
  $sql = "INSERT into `notification`(`cid`, `heading`, `description`, `ip`) VALUES('$course_id','$heading','$description','$ip');";
                ...
                <div class="form-body">
                    <form class="form-horizontal" method="post">
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-sm-9"> 
                                <input type="text" class="form-control" id="inputEmail3" name="heading" placeholder="Introduction"> 
                            </div>
                       </div>
                       <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label">Description</label> 
                            <div class="col-sm-9"> 
                                <textarea id="mytextarea" name="mytextarea" rows="20"></textarea>
                            </div>
                       </div>
