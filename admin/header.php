...
#datatable_filter{float:right !important;}
#datatable_paginate{float:right !important;}
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
          <div class="navbar-header">
            ...
            <h1><a class="navbar-brand" href="index.php"><img src="images/newlogo1.png" style="width: 55px;" ></a></h1>
          </div>
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
			  ...
			  <li class="treeview" style="background-color: #090e12">
                <a href="trainer.php" style="font-size: 18px !important;">
                <i class="fa fa-inbox"></i> <span>Trainer</span>
                </a>
              </li>
              ...
              <li class="treeview" style="background-color: #090e12">
                ...
                <ul class="treeview-menu">
                  <li><a href="addCourse.php" style="font-size: 16px !important;"><i class="fa fa-angle-right"></i> Add New Course</a></li>
                  <li><a href="addChapter.php" style="font-size: 16px !important;"><i class="fa fa-angle-right"></i> Add Chapters/Topic</a></li>
                  <li><a href="viewCourse.php" style="font-size: 16px !important;"><i class="fa fa-angle-right"></i> View Course</a></li>
                </ul>
              </li>
              <li class="treeview" style="background-color: #090e12">
                <a href="#" style="font-size: 18px !important;">
                ...
                <ul class="treeview-menu">
                  <li><a href="addNotification.php" style="font-size: 16px !important;"><i class="fa fa-angle-right"></i> Add New Notification</a></li>
                  <li><a href="viewNotification.php" style="font-size: 16px !important;"><i class="fa fa-angle-right"></i> View Notifications</a></li>
                </ul>
              </li>
              <li class="treeview" style="background-color: #090e12">
			  ...
			  <li class="treeview" style="background-color: #090e12">
                <a href="notes.php" style="font-size: 18px !important;">
                <i class="fa fa-users"></i> <span>Notes</span>
                </a>
              </li>
			  <li class="treeview" style="background-color: #090e12">
                <a href="create_notes.php" style="font-size: 18px !important;">
                <i class="fa fa-users"></i> <span>Create Notes</span>
                </a>
              </li>
              <li class="treeview" style="background-color: #090e12">
